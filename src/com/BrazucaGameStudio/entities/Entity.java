...
public class Entity {
	...
	public static BufferedImage GUN_UP = Game.spritesheet.getSprite(6*16, 32, 16, 16);
	public static BufferedImage GUN_DOWN = Game.spritesheet.getSprite(6*16, 48, 16, 16);
